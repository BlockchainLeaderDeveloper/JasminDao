...
//let allURIs = ["https://speedy-nodes-nyc.moralis.io/1b8e53affad7184a2e65e738/bsc/mainnet"];
     let allURIs = ["https://speedy-nodes-nyc.moralis.io/69399f287c98c2f6a473fcb6/bsc/testnet"]; // test net
    return allURIs;
  };
