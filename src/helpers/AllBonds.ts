...
export const busd = new StableBond({
  ...
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0xa54C94162Fb5dC8C26acd216843a8bEFBF546654",
      reserveAddress: "0xe9e7cea3dedca5984780bafc599bd69add087d56",
    },
    [NetworkID.Testnet]: {
      bondAddress: "0x564062febCf231bbEB914BE2b8b4940219c556E9",
...
export const jasmin_busd = new LPBond({
  name: "jasmin_busd_lp",
  displayName: "JASMIN-BUSD LP",
  bondToken: "BUSD",
  ...
  networkAddrs: {
    [NetworkID.Mainnet]: {
      bondAddress: "0x44A8E1e56F5c56f601F55c1B5AFEcC7BeB3A8392",
      reserveAddress: "0x9c96d18ae3acb917f3ce1e2e6df68ca860ea3cdc",
    },
    [NetworkID.Testnet]: {
      bondAddress: "0x081f4DB594744e9F3cBf4610267B55a13A80F30e",
      reserveAddress: "0x35f40d6523c38ef8eb13b6c0aae59ecd26165444",
    },
  },
  lpUrl:
    "https://pancake.kiemtienonline360.com/#/add/0x78867bbeef44f2326bf8ddd1941a4439382ef2a7/0x651591BAFf82DE7D9E9b05dE4BD3A12B61204F19",
});
...
export const allBonds = [busd, jasmin_busd];//mtn_wbnb, cake
