...
import SOhmImg from "src/assets/tokens/Wand.png";
...
function OhmMenu() {
  ...
  const USDC_ADDRESS = addresses[networkID].BUSD_ADDRESS;
  ...
  return (
    ...
    >
      <Button id="ohm-menu-button" size="large" variant="contained" color="secondary" title="Jasmin Coin" aria-describedby={id}>
        <SvgIcon component={InfoIcon} color="primary" />
        <Typography>Jasmin Coin</Typography>
      </Button>
            ...
            <Fade {...TransitionProps} timeout={100}>
              <Paper className="ohm-menu" elevation={1}>
                <Box component="div" className="buy-tokens">
                  <Link
                    href={`https://pancake.kiemtienonline360.com/#/swap?inputCurrency=${busdAddress}&outputCurrency=${WAND_ADDRESS}`}
                    target="_blank"
                    rel="noreferrer"
                  >
                ...
                {isEthereumAPIAvailable ? (
                  <Box className="add-tokens">
                    ...
                    <Box display="flex" flexDirection="row" justifyContent="space-between">
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("Jasmin", WAND_ADDRESS)}>
                        <SvgIcon
                          component={ohmTokenImg}
                          viewBox="0 0 1200 1200"
                          style={{ height: "36px", width: "36px" }}
                        />
                        <Typography variant="body1">Jasmin </Typography>
                      </Button>
                      <Button variant="contained" color="secondary" onClick={addTokenToWallet("sJasmin", SWAND_ADDRESS)}>
                      <SvgIcon
                          component={ohmTokenImg}
                          viewBox="0 0 1200 1200"
                          style={{ height: "36px", width: "36px" }}
                        />
                        <Typography variant="body1">sJasmin</Typography>
                      </Button>
                    </Box>
                  </Box>
                ) : null}
