...
import { Convert, Stake, ChooseBond, Bond, TreasuryDashboard, PoolTogether, Portfolio } from "./views";
...
function App() {
  ...
  useEffect(() => {
    ...
    if (shouldTriggerSafetyCheck()) {
      dispatch(info("Safety Check: Always verify you're on jamindao.netlify.app!"));
    }
