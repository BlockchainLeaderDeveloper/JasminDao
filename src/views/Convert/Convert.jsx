...
function Convert() {
  ...
  const convertIsClose = useSelector(state => {
    return state.account.staking && state.account.staking.convertClose;
  });
  // const testVal = ethers.utils.parseUnits("1", "gwei");
  console.log('debug convert', convertIsLive, convertIsClose, presaleBalance)
          ...
          <Paper className={`ohm-card`}>
            <Grid container direction="column" spacing={2}>
              {!convertIsClose ? (
                ...
                <Grid item>
                  <div className="card-header">
                    <div className="data-display"> 
                    {
                      convertIsLive ? 
                      (
                        <Typography variant="h5"> Conversion is live 🔥</Typography>
                      ) : (
                        <Typography variant="h5"> Conversion is Close 📞</Typography>
                      )
                    }
                ...
                <div className="staking-area">
                  {!address ? (
                    <div className="stake-wallet-notification">
                      ...
                      <Typography variant="h6">Connect your wallet to convert JASMIN token</Typography>
                    </div>
                  ) : (
                    <>
                        ...
                        <Box className="stake-action-row " display="flex" alignItems="center">
                            ...
                            (!hasAllowance("presalePD") && view === 0) ? (
                              <Box className="help-text">
                                <Typography variant="body1" className="stake-note" color="textSecondary">
                                    <>
                                      First time converting to <b>JASMIN</b>?
                                      <br />
                                      Please approve JASMIN DAO to use your <b>PD</b> to convert JASMIN
                                    </>
                                </Typography>
                              </Box>
                            ) : (
                          ...
                          <TabPanel value={view} index={0} className="stake-tab-panel">
                            {isAllowanceDataLoading ? (
                              ...
                              >
                                {txnButtonText(pendingTransactions, "converting", "Convert JASMIN")}
                              </Button>
                            ) : (
                              <Button
                                className="stake-button"
                      ...
                      <div className={`stake-user-data`}>
                        <div className="data-row">
                          <Typography variant="body1">Your Presale Token Balance</Typography>
                        ...
                        <div className="data-row">
                          <Typography variant="body1">Your JASMIN Token Balance</Typography>
                          <Typography variant="body1">
                ...
                <Grid item>
                <div className="card-header">
                  <div className="conversion-close"> 
                    <Typography variant="h5"> Conversion is Close 📞</Typography>
                    <Typography variant="body1">Contact the support team</Typography>
                    <Typography variant="body1">https://t.me/xiomtal</Typography>
                  </div>
                </div>
              </Grid>
              )
