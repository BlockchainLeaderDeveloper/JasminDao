...
function Calculator() {
    ...
    const shecBalance = useSelector(state => {
        console.log('shecBalance1',state)
    ...
    console.log('marketprice1',trimeMarketPrice);
                                ...
                                <Grid container spacing={2}>
                                    <Grid item xs={12} sm={4} md={4} lg={4}>
                                        <Box className="calculator-card-apy">
                                            <Typography variant="h5" color="textSecondary">JASMIN Price</Typography>
                                    ...
                                    <Grid item xs={6} sm={4} md={4} lg={4}>
                                        <Box className="calculator-card-index">
                                            <Typography variant="h5" color="textSecondary">Your sJASMIN Balance</Typography>
                                            <Typography variant="h4">{isAppLoading ? <Skeleton width="100px" /> : <>{trimmedBalance} sJASMIN</>}</Typography>
                                        </Box>
                                    </Grid>
                                </Grid>
                            </Box>
                        ...
                        <Box className="calculator-card-area">
                            <Box>
                                    ...
                                    <Grid container spacing={3}>
                                        <Grid item xs={12} sm={6}>
                                            <Box className="calculator-card-action-area-inp-wrap">
                                                <Typography variant="h6">sJASMIN Amount</Typography>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    ...
                                                    endAdornment={
                                                        <InputAdornment position="end">
                                                            <div onClick={() => setsHecAmount(trimmedBalance)} className="stake-card-action-input-btn">
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Box className="calculator-card-action-area-inp-wrap">
                                                <Typography variant="h6">JASMIN price at purchase ($)</Typography>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                        ...
                                        <Grid item xs={12} sm={6}>
                                            <Box className="calculator-card-action-area-inp-wrap">
                                                <Typography variant="h6">Future JASMIN market price ($)</Typography>
                                                <OutlinedInput
                                                    type="number"
                                                    placeholder="Amount"
                                                    className="calculator-card-action-input"
                                ...
                                <Box className="calculator-user-data">
                                    ...
                                    <Box className="data-row">
                                        <Typography>JASMIN rewards estimation</Typography>
                                        <Typography>{isAppLoading ? <Skeleton width="80px" /> : <>{rewardsEstimation} JASMIN</>}</Typography>
                                    </Box>
                                    <Box className="data-row">
